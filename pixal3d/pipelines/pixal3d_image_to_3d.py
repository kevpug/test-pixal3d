...
class Pixal3DImageTo3DPipeline(Pipeline):
    ...
    def run(
        ...
        with profiling.stage('cond: sparse structure'):
        ...
        ss_res = 32
        with profiling.stage('sample: sparse structure'):
        ...
        with profiling.stage('cond: shape 512'):
        ...
        with profiling.stage('sample: shape 512'):
        ...
        if self.low_vram:
            self.models['shape_slat_decoder'].to(self.device)
            self.models['shape_slat_decoder'].low_vram = True
        with profiling.stage('upsample: 512 -> HR coords'):
        ...
        with profiling.stage('cond: shape HR'):
        ...
        with profiling.stage(f'sample: shape HR ({actual_hr_resolution})'):
        ...
        with profiling.stage('cond: texture'):
        ...
        with profiling.stage('sample: texture'):
        ...
        with profiling.stage('decode: VAE -> mesh'):
